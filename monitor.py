...
def refresh_parameter_for_1_meter(flowmeter, modbus_tcp_connection):
    ...
    if flowmeter.Connect_status_meter == 0:
        ...
        return_data['flow_3'] = 0
        return_data['flow_4'] = 0
        return_data['flow_5'] = 0
        return_data['flow_6'] = 0
        return_data['flow_7'] = 0
        return_data['flow_8'] = 0
        return_data['flow_9'] = 0
        return_data['flow_10'] = 0
        return_data['flow_11'] = 0
        return_data['flow_12'] = 0
        return_data['flow_13'] = 0
        return_data['flow_14'] = 0
        return_data['high_flow_1'] = 0
        return_data['high_flow_2'] = 0
        return_data['high_flow_3'] = 0
        return_data['high_flow_4'] = 0
        return_data['high_flow_5'] = 0
        return_data['high_flow_6'] = 0
        return_data['high_flow_7'] = 0
        return_data['high_flow_8'] = 0
        return_data['high_flow_9'] = 0
        return_data['high_flow_10'] = 0
        return_data['high_flow_11'] = 0
        return_data['high_flow_12'] = 0
        return_data['high_flow_13'] = 0
        return_data['high_flow_14'] = 0
        return_data['low_flow_1'] = 0
        return_data['low_flow_2'] = 0
        return_data['low_flow_3'] = 0
        return_data['low_flow_4'] = 0
        return_data['low_flow_5'] = 0
        return_data['low_flow_6'] = 0
        return_data['low_flow_7'] = 0
        return_data['low_flow_8'] = 0
        return_data['low_flow_9'] = 0
        return_data['low_flow_10'] = 0
        return_data['low_flow_11'] = 0
        return_data['low_flow_12'] = 0
        return_data['low_flow_13'] = 0
        return_data['low_flow_14'] = 0
        return_data['conductivity'] = 0
        return_data['conductivity_high'] = 0
        return_data['conductivity_low'] = 0
        return_data['display_length'] = 0
        return_data['total_1'] = 0
        return_data['total_2'] = 0
        return_data['total_3'] = 0
        return_data['total_4'] = 0
        return_data['total_5'] = 0
        return_data['total_6'] = 0
        return_data['total_7'] = 0
        return_data['total_8'] = 0
        return_data['total_9'] = 0
        return_data['total_10'] = 0
        return_data['total_11'] = 0
        return_data['total_12'] = 0
        return_data['total_13'] = 0
        return_data['total_14'] = 0
